...
main = do
    ...
    xmproc <- spawnPipe "/usr/bin/xset -b"
    xmproc <- spawnPipe "/usr/bin/gnome-keyring-daemon"
    xmproc <- spawnPipe "/usr/lib/gnome-settings-daemon/gnome-settings-daemon"
    xmproc <- spawnPipe "/usr/bin/gnome-power-manager"
    xmproc <- spawnPipe "/usr/bin/dropboxd"
    xmonad defaults
